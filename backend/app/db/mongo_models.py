...
class JobDocument(Document):
    ...
    hiring_active: bool = True     # True = actively hiring, False = position filled/closed
    hr_email: str = ""             # HR contact email shown on LinkedIn posts
...
class CandidateDocument(Document):
    ...
    job_title: str = ""
    applied_role: str = ""         # role parsed from email subject line
    ...
    assessment_status: str = "not_sent"     # not_sent | sent | started | submitted | evaluated
    assessment_score: float = 0.0
    final_composite_score: float = 0.0
    assessment_token: Optional[str] = None
    assessment_report_id: Optional[str] = None
